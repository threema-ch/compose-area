...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "h", function() { return __wbg_self_73c7a601ff857345; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "j", function() { return __wbg_window_ca735e04cb2b0566; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return __wbg_global_99312a595fd2e761; });
...
function getInt32Memory() {
    if (cachegetInt32Memory === null || cachegetInt32Memory.buffer !== _compose_area_bg_wasm__WEBPACK_IMPORTED_MODULE_0__[/* memory */ "v"].buffer) {
        cachegetInt32Memory = new Int32Array(_compose_area_bg_wasm__WEBPACK_IMPORTED_MODULE_0__[/* memory */ "v"].buffer);
    }
...
function getUint8Memory() {
    if (cachegetUint8Memory === null || cachegetUint8Memory.buffer !== _compose_area_bg_wasm__WEBPACK_IMPORTED_MODULE_0__[/* memory */ "v"].buffer) {
        cachegetUint8Memory = new Uint8Array(_compose_area_bg_wasm__WEBPACK_IMPORTED_MODULE_0__[/* memory */ "v"].buffer);
    }
...
if (typeof cachedTextEncoder.encodeInto === 'function') {
    passStringToWasm = function(arg) {
        ...
        let size = arg.length;
        let ptr = _compose_area_bg_wasm__WEBPACK_IMPORTED_MODULE_0__[/* __wbindgen_malloc */ "f"](size);
        let offset = 0;
        {
        ...
        if (offset !== arg.length) {
            ...
            ptr = _compose_area_bg_wasm__WEBPACK_IMPORTED_MODULE_0__[/* __wbindgen_realloc */ "g"](ptr, size, size = offset + arg.length * 3);
    ...
    passStringToWasm = function(arg) {
        ...
        if (offset !== arg.length) {
            ...
            ptr = _compose_area_bg_wasm__WEBPACK_IMPORTED_MODULE_0__[/* __wbindgen_realloc */ "g"](ptr, size, size = offset + buf.length);
...
function extract_text(root_element, no_trim) {
    const retptr = 8;
    try {
        const ret = _compose_area_bg_wasm__WEBPACK_IMPORTED_MODULE_0__[/* extract_text */ "u"](retptr, addBorrowedObject(root_element), no_trim);
        const memi32 = getInt32Memory();
        const v0 = getStringFromWasm(memi32[retptr / 4 + 0], memi32[retptr / 4 + 1]).slice();
        _compose_area_bg_wasm__WEBPACK_IMPORTED_MODULE_0__[/* __wbindgen_free */ "e"](memi32[retptr / 4 + 0], memi32[retptr / 4 + 1] * 1);
        return v0;
    } finally {
...
class ComposeArea {
    ...
    */
    static bind_to(wrapper, log_level) {
        const ptr0 = isLikeNone(log_level) ? 0 : passStringToWasm(log_level);
        const len0 = WASM_VECTOR_LEN;
        const ret = _compose_area_bg_wasm__WEBPACK_IMPORTED_MODULE_0__[/* composearea_bind_to */ "h"](addHeapObject(wrapper), ptr0, len0);
    ...
    */
    store_selection_range() {
        const ret = _compose_area_bg_wasm__WEBPACK_IMPORTED_MODULE_0__[/* composearea_store_selection_range */ "t"](this.ptr);
    ...
    */
    restore_selection_range() {
        const ret = _compose_area_bg_wasm__WEBPACK_IMPORTED_MODULE_0__[/* composearea_restore_selection_range */ "r"](this.ptr);
        return ret !== 0;
    }
    /**
    ...
    */
    insert_image(src, alt, cls) {
        const ret = _compose_area_bg_wasm__WEBPACK_IMPORTED_MODULE_0__[/* composearea_insert_image */ "o"](this.ptr, passStringToWasm(src), WASM_VECTOR_LEN, passStringToWasm(alt), WASM_VECTOR_LEN, passStringToWasm(cls), WASM_VECTOR_LEN);
    ...
    */
    insert_text(text) {
        _compose_area_bg_wasm__WEBPACK_IMPORTED_MODULE_0__[/* composearea_insert_text */ "q"](this.ptr, passStringToWasm(text), WASM_VECTOR_LEN);
    }
    /**
    ...
    */
    insert_html(html) {
        _compose_area_bg_wasm__WEBPACK_IMPORTED_MODULE_0__[/* composearea_insert_html */ "n"](this.ptr, passStringToWasm(html), WASM_VECTOR_LEN);
    }
    /**
    ...
    */
    fetch_range() {
        const ret = _compose_area_bg_wasm__WEBPACK_IMPORTED_MODULE_0__[/* composearea_fetch_range */ "j"](this.ptr);
        return RangeResult.__wrap(ret);
    }
    /**
    ...
    */
    get_text(no_trim) {
        const retptr = 8;
        const ret = _compose_area_bg_wasm__WEBPACK_IMPORTED_MODULE_0__[/* composearea_get_text */ "l"](retptr, this.ptr, isLikeNone(no_trim) ? 0xFFFFFF : no_trim ? 1 : 0);
        const memi32 = getInt32Memory();
        const v0 = getStringFromWasm(memi32[retptr / 4 + 0], memi32[retptr / 4 + 1]).slice();
        _compose_area_bg_wasm__WEBPACK_IMPORTED_MODULE_0__[/* __wbindgen_free */ "e"](memi32[retptr / 4 + 0], memi32[retptr / 4 + 1] * 1);
        return v0;
    ...
    */
    get_word_at_caret() {
        const ret = _compose_area_bg_wasm__WEBPACK_IMPORTED_MODULE_0__[/* composearea_get_word_at_caret */ "m"](this.ptr);
    ...
    */
    select_word_at_caret() {
        const ret = _compose_area_bg_wasm__WEBPACK_IMPORTED_MODULE_0__[/* composearea_select_word_at_caret */ "s"](this.ptr);
        return ret !== 0;
    }
}
/**
...
class RangeResult {
    ...
    */
    to_string() {
        const retptr = 8;
        const ret = _compose_area_bg_wasm__WEBPACK_IMPORTED_MODULE_0__[/* rangeresult_to_string */ "w"](retptr, this.ptr);
        const memi32 = getInt32Memory();
        const v0 = getStringFromWasm(memi32[retptr / 4 + 0], memi32[retptr / 4 + 1]).slice();
        _compose_area_bg_wasm__WEBPACK_IMPORTED_MODULE_0__[/* __wbindgen_free */ "e"](memi32[retptr / 4 + 0], memi32[retptr / 4 + 1] * 1);
        return v0;
    ...
    */
    to_string_compact() {
        const retptr = 8;
        const ret = _compose_area_bg_wasm__WEBPACK_IMPORTED_MODULE_0__[/* rangeresult_to_string_compact */ "x"](retptr, this.ptr);
        const memi32 = getInt32Memory();
        const v0 = getStringFromWasm(memi32[retptr / 4 + 0], memi32[retptr / 4 + 1]).slice();
        _compose_area_bg_wasm__WEBPACK_IMPORTED_MODULE_0__[/* __wbindgen_free */ "e"](memi32[retptr / 4 + 0], memi32[retptr / 4 + 1] * 1);
        return v0;
...
class WordAtCaret {
    ...
    */
    node() {
        const ret = _compose_area_bg_wasm__WEBPACK_IMPORTED_MODULE_0__[/* wordatcaret_node */ "B"](this.ptr);
        return takeObject(ret);
    }
    /**
    * @returns {string}
    */
    before() {
        const retptr = 8;
        const ret = _compose_area_bg_wasm__WEBPACK_IMPORTED_MODULE_0__[/* wordatcaret_before */ "z"](retptr, this.ptr);
        const memi32 = getInt32Memory();
        const v0 = getStringFromWasm(memi32[retptr / 4 + 0], memi32[retptr / 4 + 1]).slice();
        _compose_area_bg_wasm__WEBPACK_IMPORTED_MODULE_0__[/* __wbindgen_free */ "e"](memi32[retptr / 4 + 0], memi32[retptr / 4 + 1] * 1);
        return v0;
    ...
    */
    after() {
        const retptr = 8;
        const ret = _compose_area_bg_wasm__WEBPACK_IMPORTED_MODULE_0__[/* wordatcaret_after */ "y"](retptr, this.ptr);
        const memi32 = getInt32Memory();
        const v0 = getStringFromWasm(memi32[retptr / 4 + 0], memi32[retptr / 4 + 1]).slice();
        _compose_area_bg_wasm__WEBPACK_IMPORTED_MODULE_0__[/* __wbindgen_free */ "e"](memi32[retptr / 4 + 0], memi32[retptr / 4 + 1] * 1);
        return v0;
    ...
    */
    start_offset() {
        const ret = _compose_area_bg_wasm__WEBPACK_IMPORTED_MODULE_0__[/* wordatcaret_start_offset */ "C"](this.ptr);
        return ret >>> 0;
    }
    /**
    ...
    */
    end_offset() {
        const ret = _compose_area_bg_wasm__WEBPACK_IMPORTED_MODULE_0__[/* wordatcaret_end_offset */ "A"](this.ptr);
        return ret >>> 0;
    }
}
...
const __wbg_error_4bb6c2a97407129a = function(arg0, arg1) {
    ...
    _compose_area_bg_wasm__WEBPACK_IMPORTED_MODULE_0__[/* __wbindgen_free */ "e"](arg0, arg1 * 1);
    console.error(v0);
};
...
const __widl_f_add_2_DOMTokenList = function(arg0, arg1, arg2, arg3, arg4) {
    try {
        getObject(arg0).add(getStringFromWasm(arg1, arg2), getStringFromWasm(arg3, arg4));
    } catch (e) {
        handleError(e)
    }
};
...
const __widl_f_exec_command_with_show_ui_and_value_HTMLDocument = function(arg0, arg1, arg2, arg3, arg4, arg5) {
    try {
        const ret = getObject(arg0).execCommand(getStringFromWasm(arg1, arg2), arg3 !== 0, getStringFromWasm(arg4, arg5));
        return ret;
    } catch (e) {
        handleError(e)
    }
...
const __widl_f_clone_range_Range = function(arg0) {
    const ret = getObject(arg0).cloneRange();
    return addHeapObject(ret);
};
...
const __widl_f_start_offset_Range = function(arg0) {
    try {
        const ret = getObject(arg0).startOffset;
        return ret;
    } catch (e) {
        handleError(e)
    }
...
const __widl_f_end_container_Range = function(arg0) {
    try {
        const ret = getObject(arg0).endContainer;
        return addHeapObject(ret);
    } catch (e) {
        handleError(e)
    }
...
const __widl_f_end_offset_Range = function(arg0) {
    try {
        const ret = getObject(arg0).endOffset;
        return ret;
    } catch (e) {
        handleError(e)
    }
